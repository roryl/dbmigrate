...
<cffunction name="$getDBType" returntype="string" access="private" output="false">
	<cfscript>
	var loc = {};
	loc.info = $dbinfo(type="version",datasource=variables.datasource);
...
<cffunction name="$getForeignKeys" returntype="string" access="private" output="false">
	...
	<cfscript>
	var loc = {};
	loc.foreignKeys = $dbinfo(type="foreignkeys",table=arguments.table,datasource=variables.datasource);
...
<cffunction name="$getColumns" returntype="string" access="public" output="false">
	...
	<cfset var loc = {}>
	<!--- use cfdbinfo --->
	<cfset loc.columns = $dbinfo(type="columns",table=arguments.tableName,datasource=variables.datasource)>
...
<cffunction name="$getColumnDefinition" returntype="string" access="private">
	...
	<cfset var loc = {}>
	<cfdbinfo name="loc.columns" type="columns" table="#arguments.tableName#" datasource="#variables.datasource#" username="#application.wheels.dataSourceUserName#" password="#application.wheels.dataSourcePassword#">
	<cfscript>
